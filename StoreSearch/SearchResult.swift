...
class SearchResult: Codable, CustomStringConvertible {
    ...
    var description: String {
        return NSLocalizedString("Kind: \(kind ?? "None"), Name: \(name), Artist Name: \(artistName ?? "None")", comment: "Localized kind: Kind: \(kind ?? "None"), Name: \(name), Artist Name: \(artistName ?? "None")")
    }
